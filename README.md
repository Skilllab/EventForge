...
> **Примечание:** ключ `events:top10` при удалении события или изменении заполненности мест top-10 полагается на естественное истечение TTL. Это осознанный компромисс: редкие мутации не оправдывают инвалидацию всего агрегированного кэша. Но при этом, он инвалидируется явно при сбросе количества мест у события и при подтверждении бронирования в консьюмере.
