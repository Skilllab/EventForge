...
namespace EventBookingService.Tests
{
    public class BookingServiceTests
    {
        ...
        public async Task ExecuteAsync_ShouldUpdateStatus_AndServiceShouldReturnUpdatedBooking()
        {
            ...
            var backgroundService = new BookingBackgroundService(scopeFactoryMock.Object, loggerBgMock.Object, fakeTimeProvider);
            using var cts = new CancellationTokenSource();
            ...
            var completedTask = await Task.WhenAny(updateFinished.Task, Task.Delay(5000));
        ...
        public async Task ProcessBookingAsync_ShouldRestoreAvailableSeats_WhenBookingIsRejected()
        {
            ...
            await Task.WhenAny(updateFinished.Task, Task.Delay(5000));
